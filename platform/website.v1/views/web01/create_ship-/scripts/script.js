...
CNSXPRESSMS.cns_view_section_ship_item_currency('#ship-item-currency');

CNSXPRESSMS.cns_view_section_ship_item_unit('.ship-item-unit');
                                      ...
                                      <div class="row clearfix">
                                        ...
                                        <div class="col-sm-3">
                                          <div class="form-group form-group-default required">
                                            ...
                                            <select type="text" name="unit" id="ship-item-unit-${count}"
                                        ...
                                        <div class="col-sm-3">
                                          <div class="form-group form-group-default required">
                                            ...
                                            <input type="number" name="" id="ship-item-price-${count}" placeholder="Item value"
                                              required class="form-control" autocomplete="off">
                                          </div>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row clearfix">
                                        <div class="col-sm-3">
                                          <div class="form-group form-group-default required">
                                            ...
                                            <select id="ship-item-currency-${count}" name="" required
                                        ...
                                        <div class="col-sm-3">
                                          <div class="form-group form-group-default required">
                                            ...
                                            <input type="number" name="" id="ship-item-weight-${count}" placeholder="Weight(Kg)"
                                        ...
                                        <div class="col-sm-3">
                                          <div class="form-group form-group-default required">
                                            ...
                                            <input type="text" name="" id="ship-item-dimension-${count}"
...
let _GLOBAL_PRODUCTS_OPTIONS_LIST_ = "";
function set_product_list_options(count = 1, selected = '') {
  let row_tr_table = `<option value="">Select</option>`;
  var response = _GLOBAL_PRODUCTS_OPTIONS_LIST_;
  // if (response.status == 200) {
  //     for (const index in response.data) {
  //         let data = response.data[index];
  //         row_tr_table = row_tr_table +
  //             `
  //         <option value="${data.token_auth}" ${selected === data.token_auth ? "selected" : ""} >${data.name} / ${data.unit_name}  </option>`;
  //     }
  // }
  $('#stock-product-' + count).html(row_tr_table);
}
