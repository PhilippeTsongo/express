...
class Functions
{
    ...
    public static function active_li_menu($_request = 'request', $_match_01, $_match_02 = false,  $_match_03 = false,  $_match_04 = false,  $_match_05 = false, $_match_06 = false, $_match_07 = false){
        ...
        return true;
            ...
            return true;
        else if($_match_06 && $_match_06 == $url_struc['tree'])
            return true;
        else if($_match_07 && $_match_07 == $url_struc['tree'])
            return true;
        return false;
    }
        ...
        <div class="modal fade" id="smartModal" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <form class="form-group action-form" id="SUBMITACTIONFORM" method="post" >
                        <div class="modal-body">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Action Label</label>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input type="hidden" name="request" id="request" value="">
                            <input type="hidden" name="webToken" id="webToken" value="">
                            <input type="hidden" name="_id_" id="token" value="">
                            <input type="hidden" name="ship-status" id="status" value="">
                            <input type="hidden" name="ship-status_stage" id="status-stage" value="">

                            <button type="button" class="btn btn-default btn-close" data-dismiss="modal">Cancel</button>
                            <button type="submit" id="SUBMITACTIONBUTTON" class="btn btn-primary btn-action">Action</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    public static function smartModalBetaShip(){
        ?>
        <!-- Action Smart Modal -->
                ...
                <div class="modal-content">
                    ...
                    <form class="form-group action-form" id="SUBMITACTIONFORM" method="post" >
                        ...
                        <div style="margin: 20px 50px;">
                            <label for="">Enter a comment to explain the customer the status of his shipment</label>
                            <input type="text" required class="form-control" name="status_comment" id="status-comment" value="" style="border: silver 1px solid; border-radius: 10px; background-color: white;">
                        </div>
