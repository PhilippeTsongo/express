...
class CNS_STORE_Product
{
	...
	{
		if (!$this->_db->insert('cns_store_product', $fields)) 
	...
	{
		if (!$this->_db->update('cns_store_product', $id, $fields)) 
			throw new Exception('There was a problem updating');
	}

	# CREATE UNITS
	public function insert_unit($fields = array())
	{
		if (!$this->_db->insert('cns_store_product_unit', $fields)) 
			throw new Exception("There was a problem creating an account.");
	}

	# UPDATE UNITS
	public function update_unit($fields = array(), $id = null)
	{
		if (!$this->_db->update('cns_store_product_unit', $id, $fields)) 
			throw new Exception('There was a problem updating');
	}

	# CREATE SHELF
	public function insert_shelf($fields = array())
	{
		if (!$this->_db->insert('cns_store_product_shelf', $fields)) 
			throw new Exception("There was a problem creating an account.");
	}

	# UPDATE SHELF
	public function update_shelf($fields = array(), $id = null)
	{
		if (!$this->_db->update('cns_store_product_shelf', $id, $fields)) 
			throw new Exception('There was a problem updating');
	}

	# CREATE CATEGORY
	public function insert_category($fields = array())
	{
		if (!$this->_db->insert('cns_store_product_category', $fields)) 
			throw new Exception("There was a problem creating an account.");
	}

	# UPDATE CATEGORY
	public function update_category($fields = array(), $id = null)
	{
		if (!$this->_db->update('cns_store_product_category', $id, $fields)) 
			throw new Exception('There was a problem updating');
	}
