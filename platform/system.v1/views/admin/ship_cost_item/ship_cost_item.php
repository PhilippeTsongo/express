    ...
    <form action="" id="FILTERFORM" class="row " method='post'>
        <div class="col-md-6 action-btn hidden" style="padding-top: 0px;">
            <input type="hidden" name="request" id="request" value="hWdzbgvdAV5KQpOGLVZSHgijH5qyjmwW/dVInTH6jc0">
                ...
                <div class="col-lg-12">
                    <div class="view-header">
                        ...
                        <div class="header-title">
                            <h3> Shipment Cost Items</h3>
                            <small>
                                 Shipment cost items List
                            </small>
                        </div>
                    </div>
                    <hr>
