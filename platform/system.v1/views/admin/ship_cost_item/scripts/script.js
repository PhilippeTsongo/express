                ...
                <td>
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item" href="${Init.DNWEB}penalties/data/${token}"> <i class="fa fa-trash"></i> Delete </a></li>
...
function smartModalPopUp(paramType, paramID, paramName) {
  ...
  if (paramType == 'activateModal') {
    ...
    modalTitle = 'Activation Ship Cost Item';
    modalContent = '<span class="text-center">Do you really want to activate this ship cost item ' + paramName + ' ?</span>';

    request = 'hWdzbgvdAV5KQpOGLVZSHqMus/Rf4wCV+NrsKfMV/TdTwtcdA0V22z7g89U33yCT';
    webToken = 'FZrp/HEwJwWCrAH303ypUQ';

    btnAction = 'Activate Ship Cost Item';
    status = "ACTIVE";
  }

  if (paramType == 'deactivateModal') {
    requestType = 'admin-deactivate';
    modalTitle = 'Deactivation Ship Cost Item';
    modalContent = '<span class="text-center">Do you really want to deactivate this ship cost item ' + paramName + ' ?</span>';

    request = 'hWdzbgvdAV5KQpOGLVZSHsb6gYV0hMN0uPK9jYYXEnxwvJAFxHUAbeeZ1kdDzcaX';
    webToken = 'FZrp/HEwJwWCrAH303ypUQ';

    btnAction = 'Deactivate Ship Cost Item';
    status = "DEACTIVATE";
  }
