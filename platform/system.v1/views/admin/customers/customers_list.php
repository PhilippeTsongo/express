                ...
                <div class="panel panel-filled" >
                    <div class="panel-body">
                        <form action="" id="FILTERFORM" class="row " method='post'>
                            ...
                            <!-- WEBTOKEN AND REQUEST -->
                            <input type="hidden" name="request" id="request" value="7/i/0OQVOJ+tVgkyzdU2vInVLdKsazDsBmxDpxydBe8">
                            ...
                            <div class="col-lg-4">
                                <div class="input-group m-b-xs m-t-xs">
                                    <input type="text" class="form-control filter-keyword" value="" id="filter-keyword" name="filter-keyword" placeholder="Search by First Name.." aria-describedby="button-addon2">
