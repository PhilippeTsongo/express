                        ...
                        <div class="panel-body">
                            <form class="form-group registration-form" id="SUBMITCREATIONFORM" method="post" style="margin-bottom: 0px;" >
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control col-md-12" id="admin-firstname" required name="ship-purpose-name" placeholder="Designation">
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-12 col-form-label">Description</label>
                                    <textarea class="form-control" id="article-description" name="ship-purpose-description" placeholder="Ship Purpose Description"></textarea>
                                </div>
                                <!-- <hr> -->
                                <div class="modal-footer">
                                    <input type="hidden" name="request" id="request" value="hWdzbgvdAV5KQpOGLVZSHgXaL7+6n/DBteDjzL6O7vJo8qHbTvqCkFyU7umbKI3c">
