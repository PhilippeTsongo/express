                ...
                <div class="col-lg-12">
                    <div class="view-header">
                        <div class="pull-right text-right" style="line-height: 14px">
                            <small style="font-size: 16px;"><br><br> <span class="c-white"> <a href="<?=DNADMIN?>/event/new" class="text-warning" style="color: white !important;"> <span class="pe-7s-add-user"></span> New ICCN Event</a> </span></small>
            
                                    <form action="" id="filterForm" class="row " method='post'>
                                        <div class="col-md-6 action-btn hidden" style="padding-top: 0px;">
                                            <input type="hidden" name="request" id="request" value="<?=$HASH->encryptAES('iccn-event-list')?>">
