...
function smartModalPopUp(paramType, paramID, paramName) {
  ...
  if (paramType == 'activateModal') {
    ...
    modalTitle = 'Package Activation';
    modalContent = '<span class="text-center">Do you really want to activate this Package ' + paramName + ' ?</span>';

    request = 'nvIegZX2EEVx1VlVgF9Xzml2XPrIeVj5CqUdPBADHHY';
    webToken = 'FZrp/HEwJwWCrAH303ypUQ';

    btnAction = 'Activate Package';
    status = "ACTIVE";
  }

  if (paramType == 'deactivateModal') {
    requestType = 'admin-deactivate';
    modalTitle = 'Package Deactivation';
    modalContent = '<span class="text-center">Do you really want to deactivate this Package ' + paramName + ' ?</span>';

    request = 'nvIegZX2EEVx1VlVgF9XzlyU9dI+FIxXAMQOT7EU++o';
    webToken = 'FZrp/HEwJwWCrAH303ypUQ';

    btnAction = 'Deactivate Package';
    status = "DEACTIVATION";
  }
  ...
  if (paramType == 'deleteModal') {
    ...
    modalContent = '<span class="text-center">Do you really want to delete this Package ' + paramName + ' ?</span>';

    request = '';
    webToken = 'FZrp/HEwJwWCrAH303ypUQ';

    btnAction = 'Delete Package';
    status = "Delete";
  }
