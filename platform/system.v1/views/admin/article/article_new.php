                    ...
                    <div class="panel panel-filled">
                        ...
                        <div class="panel-body">
                            <form class="form-group registration-form" id="SubmitRegisterForm" method="post" style="margin-bottom: 0px;" >
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Article Date Time</label>
                                    <div class="col-sm-5">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <select name="article-media_type" id="article-media_type" required class="form-control">
                                            <option value="1">Image Link</option>
                                            <option value="2">Video Youtube Link</option>
                                ...
                                <div class="modal-footer">
                                    <input type="hidden" name="request" id="request" value="<?=$HASH->encryptAES('iccn-article-new')?>">
