                ...
                <div class="col-lg-12">
                    <div class="view-header">
                        <div class="pull-right text-right" style="line-height: 14px">
                            <small style="font-size: 16px;"><br><br> <span class="c-white"> <a href="<?= DNADMIN ?>/item/type/new" class="text-warning" style="color: white !important;"> <span class="pe-7s-home"></span> New</a> </span></small>
                        </div>
                        <div class="header-icon">
                            <i class="pe page-header-icon pe-7s-note2"></i>
                        </div>
                        <div class="header-title">
                            <h3>Item Type List</h3>
                            <small>
                                Item Type List
                            </small>
                        </div>
                ...
                <div class="panel panel-filled" >
                    <div class="panel-body">
                        <form action="" id="FILTERFORM" class="row " method='post'>
                            ...
                            <!-- WENTOKEN AND REQUEST -->
                            <input type="hidden" name="request" id="request" value="faanuN5Y9BLhF3jmkhDyhYRjqIyMFsyae6YWuv1f7fs">
