                ...
                <td>
                  <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="${Init.DN}item/type/edit/${data.token_id}" class="dropdown-item"> <i class="fa fa-pencil"></i> Edit </a></li>
...
function smartModalPopUp(paramType, paramID, paramName) {
  ...
  if (paramType == 'activateModal') {
    ...
    modalTitle = 'Item Type Activation';
    modalContent = '<span class="text-center">Do you really want to activate this Item Type ' + paramName + ' ?</span>';

    request = 'faanuN5Y9BLhF3jmkhDyhRxjALg2tePptgmCEndv9KQ';
  ...
  if (paramType == 'deactivateModal') {
    ...
    modalTitle = 'Item Type Deactivation';
    modalContent = '<span class="text-center">Do you really want to deactivate this Item Type ' + paramName + ' ?</span>';

    request = 'faanuN5Y9BLhF3jmkhDyhUlZ072krTcFnA5a40xeEogOVPubVBhFr8pjaSaEntCn';
    webToken = 'FZrp/HEwJwWCrAH303ypUQ';

    btnAction = 'Deactivate Item Type';
    status = "DEACTIVATION";
  }

  if (paramType == 'deleteModal') {
    requestType = 'admin-deactivate';
    modalTitle = 'Delete Item Type';
    modalContent = '<span class="text-center">Do you really want to delete this Item Type ' + paramName + ' ?</span>';

    request = 'faanuN5Y9BLhF3jmkhDyhZV3gNOCSmjfXpuB0eeCaJk';
    webToken = 'FZrp/HEwJwWCrAH303ypUQ';

    btnAction = 'Delete Item Type';
    status = "DELETE";
  }
