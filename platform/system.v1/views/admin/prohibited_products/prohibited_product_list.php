    ...
    <form action="" id="FILTERFORM" class="row " method='post'>
        <div class="col-md-6 action-btn hidden" style="padding-top: 0px;">
            <input type="hidden" name="request" id="request" value="L7tFiyQzEOUgB+m2lotqUFLEYvf0Lk8eWC82YA9h3lcKAiP3cIK8jV/iWCAeb+nZ">
                ...
                <div class="col-lg-12">
                    <div class="view-header">
                        <div class="pull-right text-right" style="line-height: 14px">
                            <small style="font-size: 16px;"><br><br> <span class="c-white"> <a href="<?= DNADMIN ?>/prohibited/product/new" class="text-warning" style="color: white !important;"> <span class="pe-7s-home"></span> New</a> </span></small>
                        </div>
                        ...
                        <div class="header-title">
                            ...
                            <small>
                                List of all prohibited products
                            </small>
                        </div>
                    </div>
                    <hr>
