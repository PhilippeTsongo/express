    ...
    <form action="" id="FILTERFORM" class="row " method='post'>
        <div class="col-md-6 action-btn hidden" style="padding-top: 0px;">
            <input type="hidden" name="request" id="request" value="Tl2DakspCD9eiAFbHw7urKuF9SkbKQWSj7b+A/2at/muzR7+AhiVDaVR1RDxLia4">
                ...
                <div class="col-lg-12">
                    <div class="view-header">
                        <div class="pull-right text-right" style="line-height: 14px">
                            <small style="font-size: 16px;"><br><br> <span class="c-white"> <a href="<?= DNADMIN ?>/destination/country/new" class="text-warning" style="color: white !important;"> <span class="pe-7s-home"></span> New</a> </span></small>
                        </div>
                        <div class="header-icon">
                            <i class="pe page-header-icon pe-7s-note2"></i>
                        </div>
                        <div class="header-title">
                            <h3>Working Destination Countries</h3>
                            <small>
                ...
                <div class="col-md-12">
                    <div class="panel panel-filled">
                        <div class="panel-heading">
                            List of all working destination countries
                        </div>
                        <div class="panel-body">
