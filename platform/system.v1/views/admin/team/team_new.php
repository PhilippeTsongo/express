                    ...
                    <div class="panel panel-filled">
                        ...
                        <div class="panel-body">
                            <form class="form-group registration-form" id="SubmitRegisterForm" method="post" style="margin-bottom: 0px;" >
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Fonction</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="team-profession" required name="team-profession" placeholder="Fonction">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="modal-footer">
                                    <input type="hidden" name="request" id="request" value="<?=$HASH->encryptAES('iccn-team-new')?>">
