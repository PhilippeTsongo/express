                ...
                <div class="col-lg-12">
                    <div class="view-header">
                        <div class="pull-right text-right" style="line-height: 14px">
                            <small style="font-size: 16px;"><br><br> <span class="c-white"> <a href="<?= DNADMIN ?>/delivery/agent/new" class="text-warning" style="color: white !important;"> <span class="pe-7s-home"></span> New</a> </span></small>
                        </div>
                ...
                <div class="panel panel-filled" >
                    <div class="panel-body">
                        <form action="" id="FILTERFORM" class="row " method='post'>
                            ...
                            <input type="hidden" name="request" id="request" value="qFX+tHrEhVFqBqxcyEV1MgbRsI33nxfhi9cvcrOWgCk">
